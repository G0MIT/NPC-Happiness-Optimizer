...
namespace HappinessOptimizer
{
  public class NPC
  {
    ...
    protected const double HATE_BUY_MODIFIER = 1.12;

    protected const double LOVE_SELL_MODIFIER = 1.14;
    protected const double LIKE_SELL_MODIFIER = 1.06;
    protected const double DISLIKE_SELL_MODIFIER = 0.94;
    protected const double HATE_SELL_MODIFIER = 0.89;
    ...
    protected const double MAX_SELL_MODIFIER = 0.75;
    ...
    public void CalculateModifier()
    {
      ...
      if (BuyModifier > MAX_BUY_MODIFIER)
      {
        BuyModifier = MAX_BUY_MODIFIER;
      }
      else if (BuyModifier < MIN_BUY_MODIFIER)
      {
        BuyModifier = MIN_BUY_MODIFIER;
      }

      if (SellModifier < MIN_SELL_MODIFIER)
      {
        SellModifier = MIN_SELL_MODIFIER;
      }
      else if (SellModifier > MAX_SELL_MODIFIER)
      {
        SellModifier = MAX_SELL_MODIFIER;
      }
    }
